...
const MockData = {
    ...
    mapData: [
        ...
        { name: '台湾省', value: 500, intensity: 0.9, status: 'ok', cp: [121.5, 25.03] },
        { name: '香港特别行政区', value: 50, intensity: 0.5, status: 'ok', cp: [114.17, 22.28] },
        { name: '澳门特别行政区', value: 20, intensity: 0.4, status: 'ok', cp: [113.54, 22.19] }
    ],
